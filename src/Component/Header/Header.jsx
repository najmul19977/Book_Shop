...
import img1 from './../../assets/img/book-cover1.jpg';
import img2 from './../../assets/img/book-cover2.jpg';
import img3 from './../../assets/img/book-shop1.jpg';
    ...
    return (
        <div className="carousel w-full">
            <div id="slide1" className="carousel-item relative w-full ">
                    ...
                    <img src={img3} className="w-full max-h-screen" />
